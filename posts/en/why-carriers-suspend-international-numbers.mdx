...
Nexitel was built with international users in mind. [Blue plans](https://www.nexitel.us/plans) include roaming in over 170 countries as a standard feature, not an afterthought.
...
Choosing a carrier that supports international usage by design, rather than treating it as an anomaly, is the most reliable way to avoid suspensions. Explore [Nexitel Blue plans](https://www.nexitel.us/plans) for international-friendly service, or visit [support](https://www.nexitel.us/support) for help transitioning from a carrier that has flagged your account.
